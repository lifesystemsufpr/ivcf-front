        ...
        <Card padding="lg" className="w-full max-w-3xl space-y-4">
          <CardHeader>
            ...
            <Typography variant="small" className="text-muted-foreground">
              Não localizamos os dados desta avaliação. Inicie um novo
              questionário para continuar.
            </Typography>
          </CardHeader>
          <CardContent className="flex gap-3">
            <Button
              variant="outline"
              onClick={() => navigate(clientRoutes.IVCF.LIST)}
            >
              Voltar à lista
            </Button>
      ...
      <Card padding="lg" className="w-full max-w-4xl">
        ...
        <CardContent className="space-y-6">
          <Box className="grid gap-4 sm:grid-cols-2">
            ...
            <Card
              className={`border ${styles.bg} ${styles.border}`}
              padding="md"
            >
              <Typography variant="small" className="text-muted-foreground">
                Classificação
